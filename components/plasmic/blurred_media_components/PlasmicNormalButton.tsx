...
import sty from "./PlasmicNormalButton.module.css"; // plasmic-import: p0J7lT78rku/css
...
export type PlasmicNormalButton__VariantMembers = {
  showStartIcon: "showStartIcon";
  showEndIcon: "showEndIcon";
  state: "isDisabled" | "formIncomplete";
...
export type PlasmicNormalButton__VariantsArgs = {
  showStartIcon?: SingleBooleanChoiceArg<"showStartIcon">;
  showEndIcon?: SingleBooleanChoiceArg<"showEndIcon">;
  state?: MultiChoiceArg<"isDisabled" | "formIncomplete">;
...
type VariantPropType = keyof PlasmicNormalButton__VariantsArgs;
export const PlasmicNormalButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "state",
  "shape",
...
export type PlasmicNormalButton__ArgsType = {
  children?: React.ReactNode;
  startIcon?: React.ReactNode;
  endIcon?: React.ReactNode;
  link?: string;
};
type ArgPropType = keyof PlasmicNormalButton__ArgsType;
export const PlasmicNormalButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicNormalButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultNormalButtonProps extends pp.BaseButtonProps {
  state?: MultiChoiceArg<"isDisabled" | "formIncomplete">;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
...
function PlasmicNormalButton__RenderFunc(props: {
  variants: PlasmicNormalButton__VariantsArgs;
  args: PlasmicNormalButton__ArgsType;
  overrides: PlasmicNormalButton__OverridesType;
  forNode?: string;
}) {
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_hgfOrange]: hasVariant($state, "color", "hgfOrange"),
          ...
          [sty.rootstate_formIncomplete]: hasVariant(
            $state,
            "state",
            "formIncomplete"
          ),
          [sty.rootstate_isDisabled]: hasVariant($state, "state", "isDisabled")
        }
      )}
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        <div
          ...
          className={classNames(projectcss.all, sty.startIconContainer, {
            ...
            [sty.startIconContainercolor_hgfOrange]: hasVariant(
              $state,
              "color",
              "hgfOrange"
            ),
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__b1X6D)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStartIcon, {
              ...
              [sty.slotTargetStartIconcolor_hgfOrange]: hasVariant(
                $state,
                "color",
                "hgfOrange"
              ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainerstate_isDisabled]: hasVariant(
            $state,
            "state",
            "isDisabled"
          )
      ...
      >
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_hgfOrange]: hasVariant(
              $state,
              "color",
              "hgfOrange"
            ),
            ...
            [sty.slotTargetChildrensize_minimal_color_link]:
              hasVariant($state, "color", "link") &&
              hasVariant($state, "size", "minimal"),
            [sty.slotTargetChildrenstate_isDisabled]: hasVariant(
              $state,
              "state",
              "isDisabled"
            )
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__fpeEc)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicNormalButton>(
    PlasmicNormalButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicNormalButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicNormalButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicNormalButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicNormalButton__ArgProps,
          internalVariantPropNames: PlasmicNormalButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicNormalButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicNormalButton";
  } else {
    func.displayName = `PlasmicNormalButton.${nodeName}`;
  }
  return func;
}

export const PlasmicNormalButton = Object.assign(
  // Top-level PlasmicNormalButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicNormalButton
    internalVariantProps: PlasmicNormalButton__VariantProps,
    internalArgProps: PlasmicNormalButton__ArgProps,

    useBehavior
  }
);

export default PlasmicNormalButton;
/* prettier-ignore-end */
